...
export const ChevronRight = () => (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      {" "}
      <title>chevron-right</title> <desc>Created with Sketch Beta.</desc> <defs> </defs>{" "}
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        {" "}
        <g id="Icon-Set-Filled" transform="translate(-474.000000, -1196.000000)" fill="#2c313a">
          {" "}
          <path
...
export const ChevronDown = () => (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      {" "}
      <title>chevron-down</title> <desc>Created with Sketch Beta.</desc> <defs> </defs>{" "}
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        {" "}
        <g id="Icon-Set-Filled" transform="translate(-574.000000, -1201.000000)" fill="#2c313a">
          {" "}
          <path
